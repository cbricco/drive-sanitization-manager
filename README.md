...
Development safety work has progressed beyond the current non-destructive
Version 1 workflow. Destructive behavior has been tested only against
disposable synthetic media: first a private regular-file harness and then a
separately bounded Linux loop-backed block-device harness. The loop-backed
